...
Visitor
Need: Understand services and the company; contact it or request a quote without an account.

STAFF
Need: Sign in, find and work with leads, record notes, and see relevant metrics.

ADMIN
Need: Perform staff work and manage assignments, staff, services, testimonials, and selected settings.

Goals

Step 1: Present service information clearly on common screen sizes.

Step 2: Capture valid enquiries and route them into an internal lead workflow.

Step 3: Protect internal data with server-side authentication and authorization.

Step 4: Deliver a testable, maintainable full-stack application of limited scope.
