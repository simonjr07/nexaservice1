...
| Document | Evidence |
| --- | --- |
| [Product requirements](PRODUCT_REQUIREMENTS.md) | Problem, users, stories, scope and non-goals |
| [Architecture](ARCHITECTURE.md) | Boundaries, authentication and request flows |
| [Database](DATABASE.md) | Model, constraints, indexes and migration status |
| [Interfaces](API.md) | Public/private operations and validation |
| [Tasks](TASKS.md) | Implementation checkpoints and unfinished work |
| [Decisions](DECISIONS.md) | Approved architectural and launch choices |
| [Testing](TESTING.md) | Automated coverage and browser gaps |
| [Security](SECURITY.md) | Controls and remaining risks |
| [Deployment](DEPLOYMENT.md) | Neon preparation, release gate and rollback |

The [screenshot plan](SCREENSHOTS.md) lists visual evidence to capture manually. No screenshot or hosted URL is presented as complete.
