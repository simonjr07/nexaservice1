...
| W01 | Build homepage, company, services, testimonials | F04, P01 | Public Services list/detail now read published records; remaining content scope is still planned. |
...
| M02 (Service in progress; Testimonial planned) | Build ADMIN service and testimonial management | W01, A02 | Service code and tests are implemented; ADMIN browser verification and Testimonial management remain. |
