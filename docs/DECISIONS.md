...
Still requiring approval before production: sign-in rate-limit mechanism/threshold, production administrator provisioning and recovery, and password reset/recovery policy. Lead visibility and other product decisions remain pending as recorded in the product/security documents.
