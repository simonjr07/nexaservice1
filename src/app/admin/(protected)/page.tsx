...
const modules = [
  { href: "/admin/leads", number: "01", title: "Leads", description: "A future home for enquiries, status updates, assignments, and internal notes.", adminOnly: false },
    ...
    <>
      ...
      <section className="relative mt-10 overflow-hidden rounded-[2rem] bg-deep p-8 text-white sm:p-10" aria-labelledby="preview-heading">
        ...
        <div className="relative max-w-xl">
          ...
          <p className="mt-5 text-sm leading-7 text-white/70">This workspace shows planned navigation only. It has no lead records, live metrics, or administrative actions yet.</p>
        </div>
      </section>
      ...
      <p className="mt-10 rounded-xl border border-[#d7e4d2] bg-[#eaf0e8] p-5 text-sm leading-7 text-ink"><strong>Security boundary:</strong> Staff authentication protects this workspace. Future lead and management actions will also require authorization in their server-side handlers.</p>
    </>
  );
}
